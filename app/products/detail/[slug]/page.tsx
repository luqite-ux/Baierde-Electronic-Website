...
export async function generateMetadata({ params }: ProductPageProps): Promise<Metadata> {
  ...
  const url = `https://brdelectronic.com/products/detail/${slug}`
...
export default async function ProductDetailPage({ params }: ProductPageProps) {
  ...
  const breadcrumbItems = [
    ...
    { label: product.title, href: `/products/detail/${slug}` },
  ]
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            offers: {
              ...
              priceCurrency: "USD",
              url: `https://brdelectronic.com/products/detail/${slug}`,
            },
          }),
        }}
      />
                ...
                <Card key={relatedProduct._id} className="group hover:border-primary/50 transition-colors">
                  <CardContent className="p-4">
                    ...
                    <Button asChild variant="outline" className="w-full bg-transparent" size="sm">
                      <Link href={`/products/detail/${relatedProduct.slug}`}>View Details</Link>
                    </Button>
                  </CardContent>
                </Card>
              ))}
